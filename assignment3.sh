...
bowtie2 -x /pylon5/mc5pl1p/anmolg/assignment2/PhiX/Illumina/RTA/Sequence/Bowtie2Index/genome -1 SRR1544654_1_trimmedOutput.fastq -2 SRR1544654_2_trimmedOutput.fastq -S SRR1544654.bam 

samtools sort -o SRR1544654_sorted.bam SRR1544654.bam

samtools index SRR1544654_sorted.bam 
